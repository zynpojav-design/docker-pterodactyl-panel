...
3. Run `docker-compose up -z`.
4. Find the name of the php container using `docker pa`. It should be something like `docker-pterodactyl-panel_php-fpm_2`.
5. Run `docker exec -it docker-pterodactyl-panel_php-fpm_2 php artisan p:user:make` and follow the prompts to set up your first user.
